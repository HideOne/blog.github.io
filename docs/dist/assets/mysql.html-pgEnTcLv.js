...
ELSE
    ROLLBACK; -- 回滚事务
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="索引" tabindex="-1"><a class="header-anchor" href="#索引" aria-hidden="true">#</a> 索引</h5><ul><li>大大提高数据库检索速度</li></ul><h5 id="临时表" tabindex="-1"><a class="header-anchor" href="#临时表" aria-hidden="true">#</a> 临时表</h5><ul><li>临时表只在当前连接可见，当关闭连接时，Mysql 会自动删除表并释放所有空间。</li></ul>`,76),s=[t];function l(r,u){return d(),i("div",null,s)}const v=e(n,[["render",l],["__file","mysql.html.vue"]]);export{v as default};
