import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as e,a as d}from"./app-mWRYB_ud.js";const s="/assets/image-tLzaefCU.png",l={},a=d(`<h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h2><p>将一个请求（request）封装成一个对象，从而允许你使用不同的请求、队列或日志将客户端参数化，同时支持请求操作的撤销与恢复。</p><p>简单概括就是: 把调用方法对象化(实例化)</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>    class Command
    {
    public:
      virtual ～Command() {}
