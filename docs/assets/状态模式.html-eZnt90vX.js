<<<<<<<< HEAD:docs/assets/状态模式.html-Js-7pqfq.js
import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as e,a as d}from"./app-TSzCavvZ.js";const a="/assets/image-6-2vcjNnIm.png",s="/assets/image-7-hNSAxrVA.png",l={},r=d('<h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h2><p>允许一个对象在其内部状态改变时改变自身的行为。对象看起来好像是在修改自身类</p><h2 id="场景" tabindex="-1"><a class="header-anchor" href="#场景" aria-hidden="true">#</a> 场景</h2><h3 id="需求中的问题" tabindex="-1"><a class="header-anchor" href="#需求中的问题" aria-hidden="true">#</a> 需求中的问题</h3><p>假设一个格斗游戏 通过按键实现跳跃 闪避 如果在地上 按方向键闪避 按b键跳跃 出现问: 如果没有其他比如是否在跳跃中 是否在地上的 状态控制的话 角色会有连续跳跃 空中闪避 空中站立的bug出现</p><h3 id="解决-有限状态机" tabindex="-1"><a class="header-anchor" href="#解决-有限状态机" aria-hidden="true">#</a> 解决: 有限状态机</h3><figure><img src="'+a+`" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure><p>意义:</p><ul><li>你拥有一组状态，并且可以在这组状态之间进行切换</li><li>状态机同一时刻只能处于一种状态</li><li>状态机会接收一组输入或事件</li><li>每一个状态有一组转换，每一个转换都关联着一个输入并指向另一个状态</li></ul><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>enum State
========
import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as e,a as d}from"./app-pEc7176B.js";const a="/assets/image-6-2vcjNnIm.png",s="/assets/image-7-hNSAxrVA.png",l={},r=d('<h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h2><p>允许一个对象在其内部状态改变时改变自身的行为。对象看起来好像是在修改自身类</p><h2 id="场景" tabindex="-1"><a class="header-anchor" href="#场景" aria-hidden="true">#</a> 场景</h2><h3 id="需求中的问题" tabindex="-1"><a class="header-anchor" href="#需求中的问题" aria-hidden="true">#</a> 需求中的问题</h3><p>假设一个格斗游戏 通过按键实现跳跃 闪避 如果在地上 按方向键闪避 按b键跳跃 出现问: 如果没有其他比如是否在跳跃中 是否在地上的 状态控制的话 角色会有连续跳跃 空中闪避 空中站立的bug出现</p><h3 id="解决-有限状态机" tabindex="-1"><a class="header-anchor" href="#解决-有限状态机" aria-hidden="true">#</a> 解决: 有限状态机</h3><figure><img src="'+a+`" alt="Alt text" tabindex="0" loading="lazy"><figcaption>Alt text</figcaption></figure><p>意义:</p><ul><li>你拥有一组状态，并且可以在这组状态之间进行切换</li><li>状态机同一时刻只能处于一种状态</li><li>状态机会接收一组输入或事件</li><li>每一个状态有一组转换，每一个转换都关联着一个输入并指向另一个状态</li></ul><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>enum State
>>>>>>>> a8de64f7a28eb2cfb5fad9529f60266f57025678:docs/assets/状态模式.html-eZnt90vX.js
{
    STATE_STANDING,
    STATE_JUMPING,
    STATE_DUCKING,
