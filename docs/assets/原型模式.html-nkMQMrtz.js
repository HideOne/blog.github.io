import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as e,a as s}from"./app-v9jmccLm.js";const l="/assets/image-5-tGWKNsQG.png",u={},d=s('<h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h2><p>使用特定原型实例来创建特定种类的对象，并且通过拷贝原型来创建新的对象</p><h2 id="实例" tabindex="-1"><a class="header-anchor" href="#实例" aria-hidden="true">#</a> 实例</h2><p>假设要创建怪物 一般结构图如下 <img src="'+l+`" alt="Alt text" loading="lazy"></p><p>如图所示 每一种类型怪物都需要一个生成器</p><p>使用原型模式</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>class Monster
{
public:
    virtual ～Monster() {}
