import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as e}from"./app-eWMehmB6.js";const t={},l=e(`<h2 id="什么是-shell" tabindex="-1"><a class="header-anchor" href="#什么是-shell" aria-hidden="true">#</a> 什么是 Shell</h2><ul><li>Shell 是一个用 C 语言编写的程序，是用户使用 Linux 的桥梁。</li><li>Shell 脚本（shell script），是一种为 shell 编写的脚本程序</li></ul><h2 id="声明变量" tabindex="-1"><a class="header-anchor" href="#声明变量" aria-hidden="true">#</a> 声明变量</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>RUNOOB=&quot;www.runoob.com&quot;
LD_LIBRARY_PATH=&quot;/bin/&quot;
_var=&quot;123&quot;
var2=&quot;abc&quot;
