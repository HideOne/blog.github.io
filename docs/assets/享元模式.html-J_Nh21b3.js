import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as e,a as s}from"./app-S9zmAZcH.js";const l="/assets/image-1-I2lJiA9y.png",d="/assets/image-2-ZinCj8W5.png",r="/assets/image-3-p_tfDSUB.png",a={},v=s('<h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h2><p>使用共享高效地支持大量的细粒度对象</p><h2 id="使用场景" tabindex="-1"><a class="header-anchor" href="#使用场景" aria-hidden="true">#</a> 使用场景</h2><p>广袤的森林树木 如果所有树木都单独享有数据内存占用无比巨大 并且这些数据在一帧内传入gpu完全不可能</p><p>小方框内的数据为同一份数据 <img src="'+l+`" alt="Alt text" loading="lazy"></p><p>我们可以把树木通用数据放到一个单独的类中</p><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>    class TreeModel
    { 
    private:
      Mesh mesh_;
      Texture bark_;
